...
module.exports = markdownThemeablePdf = {
    config: {
        ...
        customStylesPath: {
            ...
            description: 'You can use this stylesheet file to customize everything. The path is relative to Atom config directory <code>' + atom.getConfigDirPath() + '</code>. This relative path can also be used inside each project.',
            order: 150
        },
        enableCustomHeader: {
            type: 'boolean',
        ...
        customHeaderPath: {
            ...
            description: 'You can use this javascript file to customize the document header. The path is relative to Atom config directory <code>' + atom.getConfigDirPath() + '</code>. This relative path can also be used inside each project.',
            order: 170
        },
        enableCustomFooter: {
            type: 'boolean',
        ...
        customFooterPath: {
            ...
            description: 'You can use this javascript file to customize the document footer. The path is relative to Atom config directory <code>' + atom.getConfigDirPath() + '</code>. This relative path can also be used inside each project.',
            order: 190
        },
    ...
    activate: function () {
        ...
        ncp(customTemplatesSource, customTemplatesPath, {clobber: false}, function (err) {
            ...
            atom.notifications.addError('Custom template could not created at ' + customTemplatesPath + '. Please copy the files manualy from ' + customTemplatesSource);
